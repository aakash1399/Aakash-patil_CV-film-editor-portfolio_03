          ...
          <div className="bg-gradient-to-br from-gray-900/80 to-gray-900/40 border border-gray-800 rounded-2xl p-8">
            ...
            <div className="space-y-3 text-sm text-gray-400">
              <div className="flex items-center gap-3">
                ...
                <span>Sion Koliwada, Pratiksha Nagar, Mumbai - 400 022, India</span>
              </div>
              <div className="flex items-center gap-3">
              ...
              <div className="flex items-center gap-3">
                <Mail size={16} className="text-gold-500 shrink-0" />
                <a href="mailto:aakp@dneg.com" className="hover:text-gold-400 transition-colors">
                  aakp@dneg.com
                </a>
              </div>
              <div className="flex items-center gap-3">
        ...
        <div className="grid sm:grid-cols-2 gap-6">
          ...
          >
            ...
            <div>
              ...
              <p className="text-white font-medium text-sm">aakp@dneg.com</p>
            </div>
          </a>
          ...
          <div className="flex items-center gap-4 bg-gray-900/80 border border-gray-800 rounded-xl p-6">
            ...
            <div>
              ...
              <p className="text-white font-medium">Sion Koliwada, Pratiksha Nagar, Mumbai - 400 022</p>
            </div>
          </div>
        </div>
        ...
        {/* Personal Details */}
         <div className="mt-12 text-center">
          <div className="inline-flex flex-wrap justify-center gap-6 text-sm text-gray-500">
            ...
            <span>•</span>
            <span>Work Mode: Office & Remote</span>
          </div>
        </div>
      </div>
    </section>
